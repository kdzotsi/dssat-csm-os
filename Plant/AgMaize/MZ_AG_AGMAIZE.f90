...
! Phenology variables
   ...
   integer, dimension(20) :: gstdyrdoySim, gstddoySim, gstdyearSim
   integer :: growthStage
   real :: gti, tlu, tnleafrm, tnleaf, lftips, anthes, silk, olg, dvs, dvsrate, tmpa, rla, gddcer, dtt
   real :: gddae, gddten, gddapsim, tnleafphot, tnleaftemp, stLayer1, rlaSoil, rlaAir, lfnc, xstage

! Leaf area variables
   integer :: lfn
   real, dimension(50) :: lapot, greenla, greenlaSilk, lamaxpot, lflon
...
! Root growth
   ...
   real :: cumdep, rtdep, rwuep1
   character(len=1) :: iswwat, iswnit
   character(len=12) :: files
   character(len=80) :: pathsr, pathex

! Nitrogen
   real, dimension(nl) :: unh4, uno3
   real:: rootn, stovn, ranc, tanc, trnu, nfac, agefac, ndef3, nstres
